...
function App() {
  ...
  const handleGenerate = async () => {
    try {
      ...
      if (!response.data || !response.data.generated_sentence || typeof response.data.generated_sentence !== "object") {
      ...
      const { mnemonic, summary, story, simplified_text, key_points, main_topics } = response.data.generated_sentence;
      ...
      const formattedResponse = `
        ...
        <b>Simplified Text:</b> ${simplified_text || "N/A"}<br><br>
